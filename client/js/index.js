...
async function checkUsername() {
  ...
  let response = await fetch(`https://signup-jwt.onrender.com/check-username?username=${username}`);
  let data = await response.json()
  if (data.available) {
...
async function checkEmail() {
  ...
  let response = await fetch(`https://signup-jwt.onrender.com/check-email?email=${email}`);
  let data = await response.json()
  if (data.available) {
...
async function validateForm(e) {
  ...
  let response = await fetch("https://signup-jwt.onrender.com/signup", {
    method: "POST",
    headers: {
